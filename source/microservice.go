...
func setFrameworkGlobals() {
	...
	framework.DefaultSocketPort = 7142 // Sony Bravia API's default socket port
	framework.CheckFunctionAppendBehavior = "Remove older instance"
	framework.MicroserviceName = "OpenAV NEC FPD Microservice"
	...
	// At least some NEC devices can be slow to respond, so give them a little more than the default timing
	framework.TryReadTimeout = 1000 // milliseconds
	framework.ReadFailSleep = 2000  // milliseconds
}
